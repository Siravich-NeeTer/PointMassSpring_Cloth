...
int main()
{
	...
	Shader shaderLightBox("Shader/lightBoxVertex.shader", "Shader/lightBoxFragment.shader");
	...
	window.resizeEvents.push_back([&gPosition, &gNormal, &gAlbedoSpec, &rboDepth, &window]() {
